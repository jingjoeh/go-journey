...
Senior backend engineers need to reason about allocation, escape analysis, stack and heap behavior, ownership, and garbage collection. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain memory in your own words, including one guarantee and one non-guarantee.
