...
Senior backend engineers need to reason about policy boundaries, dependency direction, use cases, and complexity cost. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain clean architecture in your own words, including one guarantee and one non-guarantee.
