...
Senior backend engineers need to reason about transient failure classification, exponential backoff, jitter, budgets, and amplification. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain retries in your own words, including one guarantee and one non-guarantee.
