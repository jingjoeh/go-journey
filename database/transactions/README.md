...
Senior backend engineers need to reason about ACID properties, isolation anomalies, savepoints, and retry boundaries. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain database transactions in your own words, including one guarantee and one non-guarantee.
