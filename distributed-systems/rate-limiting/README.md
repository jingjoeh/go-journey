...
Senior backend engineers need to reason about token and leaky buckets, fairness, distributed state, and overload protection. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain rate limiting in your own words, including one guarantee and one non-guarantee.
