...
Senior backend engineers need to reason about linearizability, eventual consistency, read-your-writes, and business tolerance. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain consistency in your own words, including one guarantee and one non-guarantee.
