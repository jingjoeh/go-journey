...
Senior backend engineers need to reason about identity verification, session and token lifecycle, and credential safety. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain authentication in your own words, including one guarantee and one non-guarantee.
