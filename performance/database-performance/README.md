...
Senior backend engineers need to reason about query latency, pool saturation, indexes, locks, batching, and capacity. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain database performance in your own words, including one guarantee and one non-guarantee.
