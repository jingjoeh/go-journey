...
Senior backend engineers need to reason about consumer-owned interfaces, implicit satisfaction, composition, and test seams. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain interfaces in your own words, including one guarantee and one non-guarantee.
