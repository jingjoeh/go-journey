...
Senior backend engineers need to reason about domain modules, internal boundaries, data ownership, and deployment simplicity. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain modular monolith in your own words, including one guarantee and one non-guarantee.
