...
Senior backend engineers need to reason about cross-cutting HTTP behavior, ordering, scope, and dependency injection. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain middleware in your own words, including one guarantee and one non-guarantee.
