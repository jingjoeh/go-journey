...
Senior backend engineers need to reason about threat modeling, access control, input limits, privacy, and abuse resistance. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain secure api design in your own words, including one guarantee and one non-guarantee.
