...
Senior backend engineers need to reason about leases, fencing tokens, clock assumptions, and safer alternatives. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain distributed locking in your own words, including one guarantee and one non-guarantee.
