# Go Basics: Collections and Ownership

> Work in `starter/`. Do not open `solution/` until you have a tested attempt.

## Objective

Implement a small collection transformation with clear input/output ownership.

## Requirements

- Return the sum of positive values.
...
- Keep the public contract focused on `func SumPositive(values []int) int`.
