...
Senior backend engineers need to reason about generation, storage, delivery, rotation, access control, and leak response. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain secrets in your own words, including one guarantee and one non-guarantee.
