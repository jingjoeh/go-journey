...
Senior backend engineers need to reason about inventory, holds, concurrency, expiry, payment, and overselling prevention. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain booking system design in your own words, including one guarantee and one non-guarantee.
