...
Senior backend engineers need to reason about deadline and cancellation propagation, request-scoped values, and cleanup. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain context in your own words, including one guarantee and one non-guarantee.
