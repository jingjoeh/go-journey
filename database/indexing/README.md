...
Senior backend engineers need to reason about B-tree and specialized indexes, selectivity, write cost, and query support. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain indexing in your own words, including one guarantee and one non-guarantee.
