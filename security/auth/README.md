...
Senior backend engineers need to reason about credential handling, password storage, sessions, MFA, and account recovery. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain security authentication in your own words, including one guarantee and one non-guarantee.
