...
Senior backend engineers need to reason about workload models, saturation, latency distributions, bottlenecks, and safe experiments. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain load testing in your own words, including one guarantee and one non-guarantee.
