...
Senior backend engineers need to reason about goroutines, channels, synchronization, races, cancellation, and bounded work. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain concurrency in your own words, including one guarantee and one non-guarantee.
