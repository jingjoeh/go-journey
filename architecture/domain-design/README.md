...
Senior backend engineers need to reason about ubiquitous language, invariants, aggregates, boundaries, and model evolution. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain domain design in your own words, including one guarantee and one non-guarantee.
