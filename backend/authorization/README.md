...
Senior backend engineers need to reason about policy enforcement, ownership, roles, permissions, and deny-by-default design. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain authorization in your own words, including one guarantee and one non-guarantee.
