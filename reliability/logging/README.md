...
Senior backend engineers need to reason about structured events, correlation, levels, cardinality, sampling, and sensitive data. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain logging in your own words, including one guarantee and one non-guarantee.
