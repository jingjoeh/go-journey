...
Practice deriving a table-driven test suite from a compact behavioral contract.
...
- Keep the public contract focused on `func NormalizeEmail(raw string) (string, error)`.
