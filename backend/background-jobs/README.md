...
Senior backend engineers need to reason about durable work, scheduling, retries, deduplication, and shutdown. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain background jobs in your own words, including one guarantee and one non-guarantee.
