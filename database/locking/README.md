...
Senior backend engineers need to reason about row and table locks, wait graphs, deadlocks, and concurrency control. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain locking in your own words, including one guarantee and one non-guarantee.
