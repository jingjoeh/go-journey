...
Senior backend engineers need to reason about preferences, fan-out, delivery providers, retries, and observability. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain notification system design in your own words, including one guarantee and one non-guarantee.
