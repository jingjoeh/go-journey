...
Senior backend engineers need to reason about net/http semantics, routing, timeouts, request lifecycle, and response contracts. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain http in your own words, including one guarantee and one non-guarantee.
