...
Senior backend engineers need to reason about claims, signatures, key rotation, validation, revocation, and token misuse. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain jwt in your own words, including one guarantee and one non-guarantee.
