...
Senior backend engineers need to reason about profile collection, visualization, production safety, and evidence interpretation. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain pprof in your own words, including one guarantee and one non-guarantee.
