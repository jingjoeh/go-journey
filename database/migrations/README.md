...
Senior backend engineers need to reason about compatible schema evolution, data backfills, rollout ordering, and recovery. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain migrations in your own words, including one guarantee and one non-guarantee.
