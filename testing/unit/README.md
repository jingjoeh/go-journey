...
Senior backend engineers need to reason about behavior-focused table tests, boundaries, determinism, and useful failures. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain unit testing in your own words, including one guarantee and one non-guarantee.
