...
Senior backend engineers need to reason about event contracts, outbox patterns, consumers, evolution, and debugging. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain event-driven systems in your own words, including one guarantee and one non-guarantee.
