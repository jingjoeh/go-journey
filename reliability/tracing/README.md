...
Senior backend engineers need to reason about distributed context, spans, sampling, causality, and telemetry cost. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain tracing in your own words, including one guarantee and one non-guarantee.
