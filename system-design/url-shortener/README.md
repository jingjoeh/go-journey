...
Senior backend engineers need to reason about key generation, redirects, storage, caching, abuse, and analytics. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain url shortener design in your own words, including one guarantee and one non-guarantee.
