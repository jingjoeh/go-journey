...
Senior backend engineers need to reason about failure thresholds, state transitions, fallbacks, and recovery probes. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain circuit breaker in your own words, including one guarantee and one non-guarantee.
