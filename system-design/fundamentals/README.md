...
Senior backend engineers need to reason about requirements, capacity, data, APIs, components, failures, and trade-offs. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain system design fundamentals in your own words, including one guarantee and one non-guarantee.
