...
Senior backend engineers need to reason about allocation reduction, object lifetimes, pooling trade-offs, and GC pressure. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain memory optimization in your own words, including one guarantee and one non-guarantee.
