...
Senior backend engineers need to reason about catalog, inventory, orders, search, payments, and consistency boundaries. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain marketplace design in your own words, including one guarantee and one non-guarantee.
