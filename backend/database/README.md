...
Senior backend engineers need to reason about connection pools, query boundaries, scanning, errors, and resource ownership. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain database access in your own words, including one guarantee and one non-guarantee.
