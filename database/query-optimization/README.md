...
Senior backend engineers need to reason about query plans, cardinality estimates, statistics, and evidence-led tuning. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain query optimization in your own words, including one guarantee and one non-guarantee.
