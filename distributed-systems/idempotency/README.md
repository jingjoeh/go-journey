...
Senior backend engineers need to reason about operation identity, atomic result storage, concurrency, expiry, and replay. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain idempotency in your own words, including one guarantee and one non-guarantee.
