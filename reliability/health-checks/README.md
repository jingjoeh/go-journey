...
Senior backend engineers need to reason about liveness, readiness, startup probes, dependencies, and failure semantics. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain health checks in your own words, including one guarantee and one non-guarantee.
