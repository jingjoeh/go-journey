...
Senior backend engineers need to reason about error values, wrapping, classification, propagation, and boundary translation. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain error handling in your own words, including one guarantee and one non-guarantee.
