...
Senior backend engineers need to reason about signal handling, admission stopping, draining, deadlines, and cleanup. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain graceful shutdown in your own words, including one guarantee and one non-guarantee.
