...
Senior backend engineers need to reason about ledgers, idempotency, state machines, reconciliation, and provider failure. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain payment system design in your own words, including one guarantee and one non-guarantee.
