...
Senior backend engineers need to reason about real dependency behavior, isolation, fixtures, lifecycle, and CI reliability. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain integration testing in your own words, including one guarantee and one non-guarantee.
