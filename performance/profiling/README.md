...
Senior backend engineers need to reason about hypothesis-led CPU, memory, block, mutex, and execution analysis. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain profiling in your own words, including one guarantee and one non-guarantee.
