...
Senior backend engineers need to reason about impact assessment, timelines, contributing conditions, recovery, and prevention. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain incident analysis in your own words, including one guarantee and one non-guarantee.
