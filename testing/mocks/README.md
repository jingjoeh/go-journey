...
Senior backend engineers need to reason about test doubles, contract boundaries, interaction cost, and implementation coupling. The skill matters because local correctness is not enough: choices must remain understandable under concurrency, failure, growth, and operational pressure.
...
1. Explain mocks and fakes in your own words, including one guarantee and one non-guarantee.
